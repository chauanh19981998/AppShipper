package com.example.shipper.common;
...
public class Common {
    ...
    public static void setSpanStringColor(String welcom, String name, TextView textView, int color) {
        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(welcom);
        SpannableString spannableString = new SpannableString(name);
        StyleSpan boldSpan = new StyleSpan(Typeface.BOLD);
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "eat_v2";
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,
                    "Eat",NotificationManager.IMPORTANCE_DEFAULT);
            notificationChannel.setDescription("Eat");
        ...
        builder.setContentTitle(title)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),R.drawable.ic_baseline_menu_book_24));
